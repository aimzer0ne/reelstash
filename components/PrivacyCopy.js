  ...
  return (
    <div className="legal-copy">
      ...
      <p>
        ...
        DART cookies, to serve ads to our site visitors based upon their visit to this
        website and other sites on the internet. However, visitors may choose to decline
        the use of DART cookies by visiting the Google ad and content network Privacy
      ...
      <p>
        ...
        Policy for their policies on user data. For easier access, we hyperlinked to
      ...
      <p>
        ...
        know more detailed information about cookie management with specific web browsers,
